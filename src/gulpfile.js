...
gulp.task('babel', function() {
    return gulp.src([
        ...
        '../_html/assets/js/aos.js',
        '../_html/assets/js/jquery-migrate-1.4.1.min.js',
        '../_html/assets/js/touchTouch.jquery.js',
        '../_html/assets/js/jquery.maskedinput.js',
        '../_html/assets/js/modal-video.min.js',
        '../_html/assets/js/jquery.chained.min.js',
        '../_html/assets/js/sweetalert2.min.js',
        '../_html/assets/js/bootstrap-4-navbar.js',
